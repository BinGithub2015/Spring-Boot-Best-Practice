...
public class FutureUtiltilesTest {
    ...
    public void submit() {
        ...
        // 任务1
        ListenableFuture<Boolean> booleanTask = FutureUtiltiles.submit(new Callable<Boolean>() {
            @Override
        ...
        // 任务2
        ListenableFuture<String> stringTask = FutureUtiltiles.submit(new Callable<String>() {
            @Override
        ...
        // 任务3
        ListenableFuture<Integer> integerTask = FutureUtiltiles.submit(new Callable<Integer>() {
            @Override
